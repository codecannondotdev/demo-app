...
class CRUDControllerHelper extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if (! is_null(request('fromRelation'))) {
            ...
            $entities = RelationHelper::fromRelation($model, $relationParams['id'], $relationParams['relation'], $this->model);
        }
        ...
        if (! is_null(request('notFromRelation'))) {
            ...
            $model = new $relationParams['model'];
            $entities = RelationHelper::notFromRelation($model, $relationParams['id'], $relationParams['relation'], $this->model);
        }
