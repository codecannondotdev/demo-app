...
describe('FormInput', () => {
	...
	describe('Prepend-input slot accessibility', () => {
		it('sets correct id and associates with label for native input', async () => {
			wrapper = createWrapper(
				{},
				{
					'prepend-input': '<input class="prepend-input" />',
				},
			)

			await wrapper.vm.$nextTick()
			const input = wrapper.find('.prepend-input')
			const label = wrapper.find('label')
			...
			expect(input.attributes('id')).toBeDefined()
			expect(input.attributes('id')).toBe(label.attributes('for'))
			expect(input.attributes('id')).toMatch(/^v-\d+$/)
		})

		it('sets aria-required when required prop is true', async () => {
			wrapper = createWrapper(
				{ required: true },
				{
					'prepend-input': '<input class="prepend-input" />',
		...
		it('sets correct id and associates with label for PrimeVue InputText', async () => {
			wrapper = createWrapper(
				{},
				{
					'prepend-input': '<InputText v-model="value" class="prepend-input" />',
				},
			)
		...
		it('sets aria-labelledby for PrimeVue Select component', async () => {
			wrapper = createWrapper(
				{},
				{
					'prepend-input': '<Select v-model="value" :options="[]" class="prepend-select" />',
				},
			)
	...
	describe('Append-input slot accessibility', () => {
		it('sets correct id and associates with label for native input', async () => {
			wrapper = createWrapper(
				{},
				{
					'append-input': '<input class="append-input" />',
				},
			)

			await wrapper.vm.$nextTick()
			const input = wrapper.find('.append-input')
			const label = wrapper.find('label')
		...
		it('sets correct id and associates with label for PrimeVue InputText', async () => {
			wrapper = createWrapper(
				{},
				{
					'append-input': '<InputText v-model="value" class="append-input" />',
				},
			)
		...
		it('sets aria-labelledby for PrimeVue Select component', async () => {
			wrapper = createWrapper(
				{},
				{
					'append-input': '<Select v-model="value" :options="[]" class="append-select" />',
				},
			)
