	...
	<div
		...
		<div class="navigation__links-container">
			...
			<router-link
				...
				class="navigation__link-item"
				:to="{ name: 'users-list' }">
				<i class="navigation__link-icon fa-light fa-user"></i>
		...
		<div class="navigation__links-container navigation__links-container--bottom">
			<router-link
				class="navigation__link-item"
				:to="{ name: 'clear-data' }">
				<i class="navigation__link-icon fa-light fa-database"></i>
